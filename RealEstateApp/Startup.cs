...
namespace RealEstateApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "RealEstateApp", Version = "v1" });
            });
            ...
            services.AddAutoMapper(typeof(NekretninaProfile));

            services.AddScoped<IAgentRepository, AgentRepository>();
            services.AddScoped<INekretninaRepository, NekretninaRepository>();
        }
